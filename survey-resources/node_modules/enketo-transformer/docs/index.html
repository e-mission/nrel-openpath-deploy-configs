...
<p>There is also a helpful <strong>GET /transform/htmlform</strong> endpoint to easily inspect the HTML form output in the developer console. Example:
http://localhost:8085/transform/htmlform?xform=http://localhost:8081/autocomplete.xml</p>
...
<p>Releases are done each time a dependent tool needs an <code>enketo-transformer</code> change.</p>
<ol>
...
<ul>
<li>Check if <code>node-libxslt</code> has been updated because it has caused problems in the past</li>
</ul>
</li>
...
<ul>
<li>Bump to major version if downstream has to make changes.</li>
</ul>
</li>
...
<p>The aim of this requirement is to force adopters to give something back to the Enketo project, by at least spreading the word and thereby encouraging further adoption.</p>
<p>Specifications:</p>
<ol>
<li>The word &quot;Enketo&quot; is displayed using Enketo's logo.</li>
<li>The minimum font-size of &quot;Powered by&quot; is 12 points.</li>
<li>The minimum height of the Enketo logo matches the font-size used.</li>
<li>The Enketo logo is hyperlinked to https://enketo.org</li>
</ol>
<p>Example:</p>
<p>Powered by <a href="https://enketo.org"><img height="16" style="height: 16px;" src="https://enketo.org/media/images/logos/enketo_bare_150x56.png" /></a></p>
