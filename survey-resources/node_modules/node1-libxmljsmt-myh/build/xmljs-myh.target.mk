...
TARGET := xmljs-myh
DEFS_Debug := \
	'-DNODE_GYP_MODULE_NAME=xmljs-myh' \
	'-DUSING_UV_SHARED=1' \
	'-DUSING_V8_SHARED=1' \
...
LDFLAGS_Debug := \
	...
	-arch x86_64 \
	-L$(builddir) \
	-install_name @rpath/xmljs-myh.node \
	-stdlib=libc++
...
$(builddir)/xmljs-myh.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/xmljs-myh.node: LIBS := $(LIBS)
$(builddir)/xmljs-myh.node: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/xmljs-myh.node: LD_INPUTS := $(OBJS)
$(builddir)/xmljs-myh.node: TOOLSET := $(TOOLSET)
$(builddir)/xmljs-myh.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink)

all_deps += $(builddir)/xmljs-myh.node
# Add target alias
.PHONY: xmljs-myh
xmljs-myh: $(builddir)/xmljs-myh.node

# Short alias for building this shared library.
.PHONY: xmljs-myh.node
xmljs-myh.node: $(builddir)/xmljs-myh.node

# Add shared library to "all" target.
.PHONY: all
all: $(builddir)/xmljs-myh.node
